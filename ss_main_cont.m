...
tfilename = [datapath 'tbound6.txt'];
Pfilename = [datapath 'Pbound6.txt'];
Nfilename = [datapath 'Nbound6.txt'];
Efilename = [datapath 'Ebound6.txt'];
Mfilename = [datapath 'Mbound6.txt'];
