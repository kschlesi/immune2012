...
tfilename = [datapath 'tbound10.txt'];
Pfilename = [datapath 'Pbound10.txt'];
Nfilename = [datapath 'Nbound10.txt'];
Efilename = [datapath 'Ebound10.txt'];
Mfilename = [datapath 'Mbound10.txt'];
