...
PR1 = 'simp9.1';  % run from which initial condition is drawn
PR2 = 'simp9.1';  % run whose paramfile to use
t1 = 5;      % time in PR1 to use for initial condition; number or 'end'
