...
tfilename = [datapath 'tpaper5.txt'];
Pfilename = [datapath 'Ppaper5.txt'];
Nfilename = [datapath 'Npaper5.txt'];
Efilename = [datapath 'Epaper5.txt'];
Mfilename = [datapath 'Mpaper5.txt'];
