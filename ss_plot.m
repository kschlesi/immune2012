...
tfilename = [datapath 'tbound11.txt'];
Pfilename = [datapath 'Pbound11.txt'];
Nfilename = [datapath 'Nbound11.txt'];
Efilename = [datapath 'Ebound11.txt'];
Mfilename = [datapath 'Mbound11.txt'];

days = 60;       % total days run
